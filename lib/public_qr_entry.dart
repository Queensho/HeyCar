              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                SizedBox(
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    ...
                    Positioned(
                      right: compact ? -77 : -84,
                      top: compact ? -23 : -28,
                      width: compact ? 318 : 354,
                      height: compact ? 294 : 324,
                ...
                Transform.translate(
                  ...
                  child: Container(
                    ...
                    child: Stack(clipBehavior: Clip.none, children: [
                      Positioned(left: compact ? 15 : 18, top: compact ? 31 : 35, width: compact ? 190 : 208, child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [const Icon(Icons.info_outline, color: _purple, size: 22), const SizedBox(width: 10), Expanded(child: Text('Kodu aracın üzerindeki\nHeyCar etiketinde bulabilirsin.', style: TextStyle(color: _muted, fontSize: compact ? 13.5 : 15, height: 1.42)))])),
                      Positioned(right: compact ? -19 : -24, bottom: compact ? -7 : -10, width: compact ? 220 : 248, height: compact ? 128 : 142, child: Transform.rotate(angle: -0.075, child: Image.asset('assets/Qrkod.png', fit: BoxFit.contain, alignment: Alignment.bottomRight))),
                    ]),
                  ),
                ),
                const SizedBox(height: 8),
...
class _TopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    IconButton(onPressed: onMenu, icon: const Icon(Icons.menu_rounded, color: Colors.white, size: 31)),
  ]);
}
