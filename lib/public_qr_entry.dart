...
class _PublicQrEntryScreenState extends State<PublicQrEntryScreen> {
  ...
  void _open(String raw) {
    ...
    final next = Uri.base.replace(queryParameters: {'tag': token});
    html.window.location.assign(next.toString());
  }
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'QR veya etiket koduyla araç sahibine anonim mesaj bırak.',
                                    style: TextStyle(
                                      color: _muted,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'QR kodu okutamıyorsan etiketteki kodu yazarak araç sahibine ulaşabilirsin.',
                          textAlign: TextAlign.center,
                        ...
                        SizedBox(
                          ...
                          child: FilledButton(
                            ...
                            child: Text('Devam Et  →', style: TextStyle(fontSize: compact ? 16 : 18, fontWeight: FontWeight.w900)),
                          ),
                        ),
                        SizedBox(height: compact ? 12 : 16),
                        const Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('veya', style: TextStyle(color: _muted)),
                            ),
                            Expanded(child: Divider(color: _line)),
                          ],
                        ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(color: _muted, fontSize: compact ? 13 : 15),
                          ),
                        ),
                      ],
                    ),
  ...
  Widget build(BuildContext context) => Row(
        children: [
          ...
          Container(
            ...
            child: const Text('TR', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
          ),
          const SizedBox(width: 10),
