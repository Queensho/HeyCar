...
const ownerShortcutCatalog=<OwnerShortcutDefinition>[
  ...
  OwnerShortcutDefinition(id:'maintenance',title:'Bakım Geçmişi',subtitle:'Servis kayıtları',icon:Icons.build_rounded,action:'vehicles'),
  OwnerShortcutDefinition(id:'inspection',title:'Muayene',subtitle:'Tarih ve hatırlatma',icon:Icons.fact_check_rounded,action:'vehicles'),
  OwnerShortcutDefinition(id:'insurance',title:'Sigorta / Kasko',subtitle:'Poliçe bilgileri',icon:Icons.verified_user_rounded,action:'vehicles'),
