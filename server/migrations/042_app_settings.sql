...
CREATE TABLE IF NOT EXISTS app_settings (
  ...
  premium_monthly_price NUMERIC(12,2) NOT NULL DEFAULT 49.99 CHECK(premium_monthly_price>=0 AND premium_monthly_price<=100000),
  premium_yearly_price NUMERIC(12,2) NOT NULL DEFAULT 499.99 CHECK(premium_yearly_price>=0 AND premium_yearly_price<=1000000),
  premium_currency TEXT NOT NULL DEFAULT 'TRY',
